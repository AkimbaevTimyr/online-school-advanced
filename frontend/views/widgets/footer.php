<section class="bottom-section profession-container">
    <div class="bottom">
        <h5 class="bottom-header">Свяжитесь с нами</h5>
        <div class="bottom-links">
            <ul class="bottom-links-list">
                <li class="bottom-links-list-item">
                    <a href="https://www.youtube.com/watch?v=0kZUbCs1z0w">
                ...
                <li class="bottom-links-list-item">
                    <a href="whatsapp://send?phone=77713020220/">
                ...
                <li class="bottom-links-list-item">
                    <a href="https://www.instagram.com/deltaeducation.info">
