...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_locatorplus_v6_cABD" async defer></script>
<script src="https://polyfill.io/v3/polyfill.min.js?features=default" type="text/javascript"></script>
<script src="https://ajax.googleapis.com/ajax/libs/handlebars/4.7.7/handlebars.min.js" type="text/javascript"></script>
<script type="text/javascript">
    const CONFIGURATION = {
        "locations": [
            {"title":"Gagarin street 32","address1":"Gagarin street 32","address2":"Семей 070000, Казахстан","coords":{"lat":50.40501706700735,"lng":80.26718685742492},"placeId":"EitHYWdhcmluIHN0cmVldCAzMiwgU2VtZXkgMDcwMDAwLCBLYXpha2hzdGFuIjASLgoUChIJZdTDBy1l8kIRp8TyEY_TuDAQICoUChIJzRQAui1l8kIRxDKW7lVP_iM"}
        ],
